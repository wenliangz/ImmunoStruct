...
if __name__ == "__main__":
    ...
    dataset_pt1 = dataset_pt2 = ImmunoPredDataset(config,
    ...
    train_dataset_pt2, val_dataset_pt2, test_dataset_pt2 = train_dataset_pt1, val_dataset_pt1, test_dataset_pt1
    ...
    # comparative false for IEDB datasets
    train_split_dataset = SplitDataset(train_dataset_pt2, "train", binary=True, full=config.full_sequence, comparative=False, return_amino_acid=config.self_supervision)
    val_split_dataset = SplitDataset(val_dataset_pt2, "val", binary=True, full=config.full_sequence, comparative=False, return_amino_acid=config.self_supervision)
    test_split_dataset = SplitDataset(test_dataset_pt2, "test", binary=True, full=config.full_sequence, comparative=False, return_amino_acid=config.self_supervision)
    ...
    print("DONE PRE-TRAINING Stage 2")
    del train_split_dataset, val_split_dataset, test_split_dataset
    del train_loader, val_loader, test_loader
    del optimizer
