...
if __name__ == "__main__":
    ...
    wandb.init(
        ...
        name=model_str,  # display name of the run
    ...
    dataset_pt = ImmunoPredDataset(config,
    ...
    if config.self_supervision:
        accuracy, precision, recall, f1, roc_auc, pr_auc, ppvn, ppv30, os_p_value, pfs_p_value, os_p_value_bin, pfs_p_value_bin = \
            inference_SSL(config, model, test_loader, device, clinical_loader=clinical_loader, fig_save_folder=config.fig_save_folder)
    else:
        accuracy, precision, recall, f1, roc_auc, pr_auc, ppvn, ppv30, os_p_value, pfs_p_value, os_p_value_bin, pfs_p_value_bin = \
            inference(config, model, test_loader, device, clinical_loader=clinical_loader, fig_save_folder=config.fig_save_folder)
    wandb.log({
        ...
        "OS p-value": os_p_value,
        "PFS p-value": pfs_p_value,
        "OS p-value (binary immunogenicity)": os_p_value_bin,
        "PFS p-value (binary immunogenicity)": pfs_p_value_bin,
    })
